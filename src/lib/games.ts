...
// Anchor for the weekly content-drip schedule: a new puzzle or riddle
// unlocks every week for a full year, alternating type, starting the week
// after launch. Computing dates from this anchor (instead of hand-writing
// 52 date strings) keeps the schedule correct and easy to extend.
